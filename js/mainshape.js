...
(function() {
  const elmHamburger = document.querySelector('.nav-btn');
  ...
  elmHamburger.addEventListener('click', () => {
    ...
    if (overlay.isOpened === true) {
      ...
      document.getElementById("txtHamb").classList.add('is_white');
      ...
      document.getElementById("txtHamb").classList.remove('is_white');
